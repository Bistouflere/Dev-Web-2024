    ...
    <div className="flex-auto">
      <Card>
        ...
        <CardContent className="flex flex-wrap justify-between gap-6">
          <UserStatistic
            icon={<Swords className="h-10 w-10 flex-none text-purple-400" />}
            title="Games Played"
            result={games_played}
          />
          <UserStatistic
            icon={
              <ArrowUpRight className="h-10 w-10 flex-none text-green-400" />
            }
            title="Victories"
            result={victories}
          />
          <UserStatistic
            icon={
              <ArrowDownRight className="h-10 w-10 flex-none text-red-400" />
            }
            title="Defeats"
            result={defeats}
          />
          <UserStatistic
            icon={
              <ArrowRight className="h-10 w-10 flex-none text-yellow-400" />
            }
            title="Draws"
            result={draws}
          />
          <UserStatistic
            icon={<Percent className="h-10 w-10 flex-none text-blue-400" />}
            title="Winning Rate"
            result={`${winning_rate}%`}
          />
        </CardContent>
